...
Reads validate_sweep_*.tsv and generates:
  - validation_crossover_{molecule}.png (main result: noisy-optimized)
  - validation_confound_{molecule}.png (confound check: fixed-params)
...
def main() -> None:
    ...
    make_crossover_plot(
        ...
        output_file=f"validation_crossover_{molecule}.png",
        molecule=molecule,
    )
    ...
    make_crossover_plot(
        ...
        output_file=f"validation_confound_{molecule}.png",
        molecule=molecule,
    )
